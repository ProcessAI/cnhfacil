      ...
      <main className="main-content">
        <header className="topbar">
          <div className="topbar-left">
            <h1 className="topbar-title">Gerenciamento de Cursos</h1>
            <span className="topbar-subtitle">Cadastro e administração de conteúdos teóricos</span>
          </div>
          <div className="topbar-right">
            <div className="user-profile">
              <div className="user-info">
                <div className="user-name">Administrador</div>
                <div className="user-role">Gestor de Conteúdo</div>
              </div>
        ...
        <div className="courses-container">
          ...
          {cursosDisponiveis.map((curso) => (
            <div className="course-card" key={curso.id}>
              ...
              <Link to="/cadastrar-aula" className="btn-access">
                Gerenciar Aulas
              </Link>
            </div>
          ))}
